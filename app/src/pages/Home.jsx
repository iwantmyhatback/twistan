...
function Home() {
  ...
  const handleNewImage = () => {
	setImgUrl(getRandomElementSecure(images));
  };
	...
	<div className="">
      <div className="flex-col translate-y-[-10vh]">
        ...
        <div className="flex justify-center">
          <img src={imgUrl} alt="Wave" />
        </div>
        <div className="flex justify-center mt-4">
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleNewImage}>
            Wave Back
          </button>
        </div>
      </div>
